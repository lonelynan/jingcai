...
<div class="search" style=" height:215px; ">
    ...
    <div class="search_right">
        {volist name="equipment_province" id="vo"}
            ...
            <a href="{:Url('/home/equipment/getsearch',array('search'=>$search,'province'=>$vo.id))}">
    ...
    <div class="search_right">
        {volist name="equipment_category" id="vo"}
            ...
            <a href="{:Url('/home/equipment/getsearch',array('search'=>$search,'province'=>$province,'ec_id'=>$vo.id,))}">
