...
class WechatUtil
{
    ...
    public function sendMsgToOne($openid, $content)
    {
        ...
        $url ="https://api.weixin.qq.com/cgi-bin/messages/custom/send?access_token={$access_token}";        
        $post_arr = [
                        'touser' => $openid,
                        'msgtype' => 'text',
    ...
    public function sendMsgToMass($openids, $content)
    {
        ...
        $url ="https://api.weixin.qq.com/cgi-bin/messages/mass/send?access_token={$access_token}";
        $post_arr = [
                        'touser' => $openids,
                        'msgtype' => 'text',
                        'text' => ['content'=>$content]
    ...
    public function sendMsgToAll($content)
    {
        ...
        $url ="https://api.weixin.qq.com/cgi-bin/messages/mass/sendall?access_token={$access_token}";        
        $post_arr = [
