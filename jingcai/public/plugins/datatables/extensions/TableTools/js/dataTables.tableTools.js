...
TableTools.prototype = {
	 ...
	 *  @param {string} [oConfig.sInfo] Information messages, displayed as an overlay to the
	...
	/**
	 * Show a messages to the end user which is nicely styled
	 *  @param {string} message The HTML string to show to the user
	 *  @param {int} time The duration the messages is to be shown on screen for (mS)
	 */
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show information messages to let the user know what is happening */
		if ( oConfig.sInfo !== "" )
		{
			this.fnInfo( oConfig.sInfo, 3000 );
		}

		/* Add a messages at the top of the page */
		if ( oConfig.sMessage )
		{
			$('<div/>')
