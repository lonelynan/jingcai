<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:30:"./template/coupons\index2.html";i:1528682488;s:29:"./template/public\header.html";i:1528771227;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
    ...
    <div class="jcbox_content">
        ...
        <div class="jcbox_contentbox"  id="2">
            ...
            <div class="jcbox_content_box fr">
                <img class="jc01_img" src="/public/images/jc1_02.png">
            </div>
            <div class="clear"></div>
        </div>
