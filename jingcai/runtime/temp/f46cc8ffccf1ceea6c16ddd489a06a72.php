<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/admin\index.html";i:1528682361;s:44:"./application/admin/view2/public\layout.html";i:1528682356;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		...
		<div class="tDiv">
			<div class="tDiv2">
				<div class="fbutton">
					<a href="<?php echo url('Admin/admin_info'); ?>">
						...
						<tr>
							...
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									<a href="<?php echo url('Admin/admin_info',array('admin_id'=>$vo['admin_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
									<?php if($vo['admin_id'] > 1): ?>
										<a class="btn red"  href="javascript:void(0)" data-url="<?php echo url('Admin/adminHandle'); ?>" data-id="<?php echo $vo['admin_id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
									<?php endif; ?>
								</div>
							</td>
