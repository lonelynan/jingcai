<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"./application/admin/view2/activity_settings\grantCoupon.html";i:1529543798;s:44:"./application/admin/view2/public\layout.html";i:1528682356;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="handleposition"  method="post">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="coupon" value="<?php echo $info['coupon']; ?>"class="input-txt" readonly>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="expiration_date"id="expiration_date" value="<?php echo isset($info['end_date'])?$info['end_date']: ''; ?>"class="input-txt">
...
<script type="text/javascript">
    ...
    function adsubmit(state) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo url('Admin/ActivitySettings/grantCouponHandle'); ?>",
