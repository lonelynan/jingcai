<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./application/admin/view2/index\welcome.html";i:1528699540;}*/ ?>
<html>
<head>
...
<div class="warpper">
    ...
    <div class="content start_content">
        <div class="contentWarp">
            <div class="contentWarp_item clearfix">
                <div class="section_select">
                    <div class="item item_order">
                        ...
                        <div class="desc">
                            <div class="tit"><?php echo $count['visit_count']; ?></div>
                            <span>总访问量</span>
                        </div>
                        <i class="icon"></i>
                    </div>
            ...
            </div><!--      <div class="contentWarp_item clearfix">
                <div class="section_select">
                    <div class="item item_order">
                        <i class="icon"><img src="__PUBLIC__/static/images/2.png"></i>
                        <div class="desc">
                ...
                <!--    <ul>
                        <li>
                            <a href="<?php echo url('Admin/Article/articleList'); ?>">
                                <i class="ice ice_f"></i>
                                <div class="t">今日会员总数</div>
                                <span class="number"><?php echo $count['new_users']; ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo url('Admin/Article/articleList'); ?>">
                                <i class="ice ice_f"></i>
                                <div class="t">今日访问量</div>
                                <span class="number"><?php echo $count['today_login']; ?></span>
                            </a>
                        </li>
