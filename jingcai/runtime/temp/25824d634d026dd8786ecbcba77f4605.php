<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:24:"./template/user\reg.html";i:1528097078;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">   
...
<body>
    <div class="regcon">
        <a class="m-fnlogoa fn-fl" href=""><img src="__PUBLIC__/temp/img/matmass.png" style="width: 100px;margin-top: 11px"/></a><span class="m-fntit">欢迎注册</span>
        <div class="ui_tab">
            <ul class="ui_tab_nav regnav">
                <li class="uli {eq name='$reg_type' value=''}active</eq> "><a href="<?php echo url('Home/User/reg'); ?>" >手机注册</a></li>
                <li class="uli {eq name='$reg_type' value='email'}active</eq>  ">
                    <a href="<?php echo url('Home/User/reg',array('t'=>'email')); ?>">邮箱注册</a></li>
                <li class="no fn-fr loginbtn">我已注册，马上<a href="<?php echo url('Home/User/login'); ?>">登录></a></li>
            </ul>
            <?php if($reg_type == ''): ?>
                        ...
                        <div class="line liney clearfix">
                            ...
                            <div class="liner">
                                <div class="clearfix checkcon">
                                    ...
                                    <span class="fn-fl">我已阅读并同意</span><a class="itxt fn-fl" href="<?php echo url('Home/Article/detail',['article_id'=>1415]); ?>" target="_blank">《Matmass服务协议》</a>
                                    </p>
                                ...
                                <p class="v-txt" id="err_check_code">
                                    <span class="fnred">请勾选</span>我已阅读并同意<a class="itxt" href="<?php echo url('Home/Article/detail',['article_id'=>1415]); ?>" target="_blank">《Matmass服务协议》</a>
                                </p>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="fnlogin clearfix">
                        ...
                        <div class="line liney clearfix">
                            ...
                            <div class="liner">
                                ...
                                <a class="regbtn J_btn_agree" href="javascript:void(0);" onClick="check_submit();">同意协议并注册</a>
                                <p class="v-txt"><span class="fnred">请勾选</span>我已阅读并同意<a class="itxt" href="<?php echo url('Home/Article/detail',['article_id'=>1415]); ?>" target="_blank">《Matmass服务协议》</a></p>
                        </div>
                    </div>
                    </div>
                    </div>
...
<script>
    ...
    function verify(id){
        ...
        $('#'+id).attr('src','/home/user/verify/r=' + Math.random());
    }
    function check_submit(){

        $.ajax({
            type : "POST",
            url:"<?php echo url('Home/User/reg'); ?>",
            dataType: "json",
    ...
    function send_smtp_reg_code(){
        ...
        $.ajax({
            type : "POST",
            url:"<?php echo url('Home/Api/send_validate_code'); ?>",
