<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./application/admin/view2/user\ajaxindex.html";i:1528096845;}*/ ?>
    ...
    <table>
        ...
        <?php if(is_array($userList) || $userList instanceof \think\Collection || $userList instanceof \think\Paginator): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <tr data-id="<?php echo $list['id']; ?>">
                ...
                <td align="left" class="">
                    <div style="text-align: center; width: 40px;"><?php echo $list['id']; ?></div>
                </td>
                <td align="left" class="">
                ...
                <td align="center" class="handle">
                    <div style="text-align: center; width: 170px; max-width:250px;">
                        <a class="btn blue" href="<?php echo url('Admin/user/detail',array('id'=>$list['id'])); ?>"><i class="fa fa-pencil-square-o"></i>详情</a>


                        <a class="btn red"  href="javascript:void(0)" data-id="<?php echo $list['id']; ?>"  data-url="<?php echo url('Admin/user/ajax_delete'); ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                    </div>
                </td>
