<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view2/user\add_user.html";i:1528096845;s:44:"./application/admin/view2/public\layout.html";i:1528096845;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" method="post" id="add_form">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="" name="qq" id="qq" class="input-txt">
                    <span class="err"></span>
                </dd>
            </dl>
            <dl class="row">
