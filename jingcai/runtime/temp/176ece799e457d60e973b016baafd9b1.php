<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./application/admin/view2/admin\login.html";i:1528682361;}*/ ?>
<!doctype html>
...
<body>
                ...
                <div class="formContent">
                    ...
                    <div class="formInfo">
                        ...
                        <div class="formText">
                            ...
                            <img src="<?php echo url('Admin/vertify'); ?>" class="chicuele" id="imgVerify" alt="" onclick="fleshVerify()">
                        </div>
                        <div class="formText">
                        <!--	<div class="checkbox">
                            	<div class="cur">
    ...
    <script type="text/javascript">
              ...
              if(vertify && $('#theForm input[name=username]').val() != '' && $('#theForm input[name=password]').val() != ''){
                    $.ajax({
            			...
            			error : function(XMLHttpRequest, textStatus, errorThrown) {
            				$('#error').html('<span class="error">网络失败，'+textStatus+'请刷新页面后重试!</span>');
            			}
                    });
                }else{
                	return false;
        ...
        function fleshVerify(){
            $('#imgVerify').attr('src','/Admin/Admin/vertify/r/'+Math.floor(Math.random()*100));//重载验证码
        }
    </script>
</body>
</html>
