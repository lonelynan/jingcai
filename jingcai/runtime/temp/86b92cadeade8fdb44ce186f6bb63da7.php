<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"./application/admin/view2/activity_settings\activitySettings.html";i:1528682360;s:44:"./application/admin/view2/public\layout.html";i:1528682356;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="handleposition"  method="post">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="number" name="number_participants1" value="<?php echo $info['number_participants1']; ?>"class="input-txt">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="number" name="number_participants2" value="<?php echo $info['number_participants2']; ?>"class="input-txt">
...
<script type="text/javascript">
    ...
    function adsubmit(state) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo url('Admin/ActivitySettings/activitySettingsHandle'); ?>",
            ...
            success: function (data) {
                if (data.status === 1) {
                    layer.msg(data.msg, {icon: 1,time: 1000}, function() {
                        location.href = "<?php echo url('Admin/ActivitySettings/activitySettingsList'); ?>";
                    });
