<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/article\articleList.html";i:1528096847;s:44:"./application/admin/view2/public\layout.html";i:1528096845;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
    <div class="mDiv">
	  ...
	  <form class="navbar-form form-inline" action="<?php echo url('Admin/Article/articleList'); ?>" method="post">
      <div class="sDiv">
        <div class="sDiv2">
    ...
    <div class="tDiv">
      <div class="tDiv2">
          <div class="fbutton"> 
        	<a href="<?php echo url('Admin/Article/article'); ?>"><div class="add" title="新增文章"><span><i class="fa fa-plus"></i>新增文章</span></div></a>
          </div>
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
              <tr>
                ...
                <td align="center" class="handle">
                  <div style="text-align: center; width: 170px; max-width:170px;"> <a class="btn blue" target="_blank" href="<?php echo url('Home/Article/detail',array('article_id'=>$vo['article_id'])); ?>"><i class="fa fa-search"></i>查看</a>
                    <?php if(!in_array(($vo['article_id']), explode(',',""))): ?> <a class="btn red"  href="javascript:void(0)" data-url="<?php echo url('Article/aticleHandle'); ?>" data-id="<?php echo $vo['article_id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a> <?php endif; if(in_array(($vo['article_id']), explode(',',""))): ?> <a class="btn red"  href="javascript:;" onclick="layer.alert('系统文章不得删除!',{icon:2});"><i class="fa fa-trash-o"></i>删除</a> <?php endif; ?>
                    <a href="<?php echo url('Article/article',array('act'=>'edit','article_id'=>$vo['article_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
                  </div>
                </td>
