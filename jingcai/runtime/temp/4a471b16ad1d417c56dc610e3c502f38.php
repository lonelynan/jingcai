<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view2/admin\role.html";i:1528096848;s:44:"./application/admin/view2/public\layout.html";i:1528096845;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		...
		<div class="tDiv">
			<div class="tDiv2">
				<div class="fbutton">
					<a href="<?php echo url('Admin/role_info'); ?>">
							...
							<tr>
								...
								<td align="center" class="handle">
									<div style="text-align: center; width: 170px; max-width:170px;">
										<a href="<?php echo url('Admin/role_info',array('role_id'=>$vo['role_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
										<a class="btn red"  href="javascript:void(0)" data-url="<?php echo url('Admin/roleDel'); ?>" data-id="<?php echo $vo['role_id']; ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
									</div>
								</td>
