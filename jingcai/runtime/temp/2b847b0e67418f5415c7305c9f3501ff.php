<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view2/user\index.html";i:1528096845;s:44:"./application/admin/view2/public\layout.html";i:1528096845;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        ...
        <div class="tDiv">
            <div class="tDiv2">
                <div class="fbutton">
                    <a href="<?php echo Url('User/add_user'); ?>">
                ...
                <div class="fbutton">
                    <a href="<?php echo Url('User/export_user'); ?>">
...
<script>
    ...
    {
        var obj = $('.trSelected');
        var url = "<?php echo Url('Admin/User/sendMail'); ?>";
        if(obj.length > 0){
            var check_val = [];
            obj.each(function(){
